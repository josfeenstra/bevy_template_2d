...
impl PlayerAnimation {
    ...
    fn driver(mut player_query: Query<(&MovementController, &mut Sprite, &mut Self)>) {
    ...
    fn timer_driver(time: Res<Time>, mut query: Query<&mut Self>) {
    ...
    fn atlas_driver(mut query: Query<(&Self, &mut Sprite)>) {
